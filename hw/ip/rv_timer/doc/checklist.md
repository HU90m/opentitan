...
### V1
 ...
 Type         | Item                                  | Resolution      | Note/Collaterals
--------------|---------------------------------------|-----------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done            | [RV_TIMER DV document]({{<relref "dv/index.md" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Done            | [RV_TIMER Testplan]({{<relref "dv/index.md#testplan" >}})
