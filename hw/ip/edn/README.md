...
The Entropy Distribution Network (EDN) block provides both hardware and software interfaces to the [CSRNG IP](../csrng/index.html) module.
...
Please see the [entropy_src IP documentation](../entropy_src/index.html) for more information on trade-offs when creating CSRNG seeds before the completion of the FIPS-required health checks.
