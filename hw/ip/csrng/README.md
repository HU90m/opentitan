...
In NIST terms, it works with the [Entropy Source IP](../entropy_src/index.html) to satisfy the requirements as a deterministic random bit generator (DRBG) or non-deterministic random bit generator (NRBG).
