...
This checklist is for [Hardware Stage]({{< relref "/doc/project/development_stages.md" >}}) transitions for the [ROM Controller peripheral.]({{< relref "." >}})
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [ROM Controller Technical Specification]({{<relref "." >}})
...
Type          | Item                      | Resolution  | Note/Collaterals
--------------|---------------------------|-------------|------------------
Documentation | [NEW_FEATURES][]          | N/A         | No new features since D1.
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [ROM Controller DV document]()
Documentation | [TESTPLAN_COMPLETED][]                | Done        | [ROM Controller Testplan]()
